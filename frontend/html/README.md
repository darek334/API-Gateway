...
Są one ściągane przez skrypt JS w celu pokazania podstrony, lub tak jak jest to w przypadku głównej strony, otwierają się bezpośrenio poprzez żądanie otwarcia głównej strony przez przeglądarkę.
